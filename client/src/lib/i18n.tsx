...
const translations = {
  "en": {
    ...
    "leaderboardPageTitle": "Leaderboard - Rust Workbook",
    "leaderboardEmpty": "No one on the leaderboard yet",
    "leaderboardEmptyDesc": "Complete exercises to earn your spot!",
    "anonymousUser": "Learner",
    "runCode": "Run Code",
    "compiling": "Compiling...",
    "run": "Run",
    "hint": "Hint",
  ...
  "ar": {
    ...
    "leaderboardPageTitle": "لوحة المتصدرين - كتاب تمارين رست",
    "leaderboardEmpty": "لا أحد على لوحة المتصدرين بعد",
    "leaderboardEmptyDesc": "أكمل التمارين لتحصل على مكانك!",
    "anonymousUser": "متعلم",
    "runCode": "تشغيل الكود",
  ...
  "fr": {
    ...
    "leaderboardPageTitle": "Classement - Cahier d'exercices Rust",
    "leaderboardEmpty": "Personne au classement pour le moment",
    "leaderboardEmptyDesc": "Complétez des exercices pour gagner votre place !",
    "anonymousUser": "Apprenant",
    "runCode": "Exécuter",
  ...
  "es": {
    ...
    "leaderboardPageTitle": "Clasificación - Cuaderno de Rust",
    "leaderboardEmpty": "Nadie en la clasificación todavía",
    "leaderboardEmptyDesc": "¡Completa ejercicios para ganar tu lugar!",
    "anonymousUser": "Estudiante",
